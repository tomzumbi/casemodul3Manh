                    ...
                    <form action="/setting" method="post">
                        <div class="grid grid-cols-2 gap-3 lg:p-6 p-4">
                            <div class="col-span-2">
                                ...
                                <input name="password" type="password" placeholder="New Password" class="shadow-none bg-gray-100">
                            </div>
                            <div class="col-span-2">
                                <label for=""> Repassword</label>
                                <input name="repass" type="password" placeholder="Repassword" class="shadow-none bg-gray-100">
                            </div>
